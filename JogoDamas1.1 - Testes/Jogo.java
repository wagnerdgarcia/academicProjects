...
public class Jogo {
    ...
    private void criarPecas() {
        Casa casa = tabuleiro.getCasa(1, 3);
        Peca peca = new Peca(casa, Peca.PEDRA_VERMELHA);
        nPecaVermelhas++;
        Casa casa1 = tabuleiro.getCasa(1, 5);
        Peca peca1 = new Peca(casa1, Peca.PEDRA_VERMELHA);
        nPecaVermelhas++;
        Casa casa2 = tabuleiro.getCasa(3, 5);
        Peca peca2 = new Peca(casa2, Peca.PEDRA_VERMELHA);
        nPecaVermelhas++;
        Casa casa3 = tabuleiro.getCasa(5, 3);
        Peca peca3 = new Peca(casa3, Peca.PEDRA_VERMELHA);
        nPecaVermelhas++;
        Casa casa4 = tabuleiro.getCasa(2, 2);
        Peca peca4 = new Peca(casa4, Peca.PEDRA_BRANCA);
        nPecaBrancas++;
        Casa casa5 = tabuleiro.getCasa(5, 1);
        Peca peca5 = new Peca(casa5, Peca.PEDRA_VERMELHA);
        nPecaVermelhas++;
        Casa casa6 = tabuleiro.getCasa(3, 1);
        Peca peca6 = new Peca(casa6, Peca.PEDRA_VERMELHA);
        nPecaVermelhas++;
    }
