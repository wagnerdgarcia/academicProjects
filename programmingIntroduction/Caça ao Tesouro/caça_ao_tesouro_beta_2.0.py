...
#MENU INICIAL_______________________________________________________________________________________
...
while (inicio == True):   
    ...
    if   botao_iniciar.collidepoint(pos) and pressed1 :
        screen.blit(regra,(0,0))
        botao_iniciar2 = pygame.draw.rect(screen, brown,(440,565,200,110),2)
        if botao_iniciar2.collidepoint(pos) and pressed1:
            inicio = False
            print("entrou!")
            pygame.display.update()
...
#musica de fundo
som  = pygame.draw.rect(screen,black,(980,570,50,50),0)
musica= True
...
som_on = pygame.image.load('imagem/somon.jpg')
som_off = pygame.image.load('imagem/somoff.png')

#CRIANDO BOTOES
screen.blit(som_on,(980,570))
