        ...
        if(verificar1 != null){
            ...
            if (possuiPeca){
                ...
                if(destino != null){    
                    ...
                    if (!fim){
                        if(objetivoV && tipoB){
                            jogo.alteraComerSeguido(true, peca);    // Altera a Variavel comerSeguido e peçaAComer da classe jogo
                ...
                if(destino != null){    
                    ...
                    if (!fim){
                        if(objetivoV && tipoB){
                            ...
                            jogo.alteraComerSeguido(true, peca);     // Altera a variavel já verificado para que não entre novamente
                            jaVerificado = true;                     // Altera a variavel já verificado para que não entre novamente
                        }
                    }
                }
